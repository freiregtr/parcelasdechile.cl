                    ...
                    <div class="range">
                        <div class="cell-md-8">
                            ...
                            <div data-photo-swipe-gallery="gallery" data-arrows="true" data-loop="false" data-dots="false" data-swipe="true" data-items="1" class="slick-slider">
                                ...
                                <div class="item"><a data-photo-swipe-item="" data-size="886x520" href="view/componentes/img/Proyectos/Lago_Chapo/5.jpg" data-author="Michael Hull" class="thumbnail-variant-2"><img src="view/componentes/img/Proyectos/Lago_Chapo/5.jpg" alt="" width="886" height="520" class="img-responsive"></a></div>
                            ...
                            <div class="unit unit-md-horizontal unit-lg-horizontal">
                                <div class="unit-left"><img src="view/componentes/images/user-04.jpg" width="139" height="139" alt="" class="img-responsive center-block"></div>
                                <div class="unit-body">
                                    <h5>Emilia Warren</h5>
                            ...
                            <hr>
                            <div class="row">
                                <div class="col-xs-6 text-left"><a href="#" class="btn btn-primary btn-icon btn-icon btn-icon-left"><span class="icon fa-angle-left"></span><span class="text text-regular veil reveal-xs-inline">Proyecto
                                            previo</span></a></div>
