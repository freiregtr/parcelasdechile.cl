...
<div class="page text-center">
                    ...
                    <ul class="rd-navbar-nav">
                        ...
                        <li class="active"><a href="parcelacionelvolantin">Proyectos</a>
                            ...
                            <ul class="rd-navbar-dropdown">
                               <li><a href="larosaconelclavel"><img src="view/componentes/images/iconos-menu/icono-menu-lasgolondrinas.svg" class="iconos-menu" width="70"> </img>Las Golondrinas</a></li>
    ...
    <main class="page-content">
        <section class="bg-gray-lighter">
            <div class="shell text-left">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Parcelación "Las Golondrinas"</li>
                </ol>
            </div>
        </section>
        ...
        <section class=" text-center section-bottom-70 page-header bg-image-lasgolondrinas">
            <div class="shell section-100 section-lg-top-220 section-lg-bottom-205 context-dark">
                ...
                <br>
                <h1 class="shadow1">Parcelación<br><span class="text-sbold">"Las Golondrinas"</span></h1>
                <div class="range offset-top-30 text-center">
                    <div class="cell-sm-4">
                        <!-- CountTo-->
                        <div data-from="0" data-to="140" class="counter shadow1 text-medium"></div>
            ...
            <div class="shell text-md-left product">
                                    ...
                                    <div class="col-md-6">
                                        <div>
                                            <div class="context-light">
                                                <h2 class="offset-top-50 section-bottom-30">Parcelación <br> <span class="text-sbold"> "Las Golondrinas"</span></h2>
                                            </div>
                                            <p class="section-bottom-30">"Región de O'higgins"</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                ...
                <div class="container">
                    ...
                    <h2 class="offset-top-50 section-bottom-30 text-center">Venta En Blanco</h2>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                            <img src="view/componentes/img/proyectos/las_golondrinas/plano-lasgolondrinas.png" width="100%" frameborder="0" style="border:0" allowfullscreen></img>
                        </div>
                    </div>
                </div>
...
<div class="container">
            ...
            <section id="sliderproyectos ">
                ...
                <div id="child-carousel" data-arrows="true" data-loop="true" data-dots="true" data-swipe="true" data-items="1" data-xs-items="1" data-sm-items="1" data-md-items="3" data-lg-items="3" data-slide-to-scroll="1" class="slick-slider slick-child ">
                    <!-- GALERIA DE IMAGENES-->
                    <div class="item mov"><img src="view/componentes/img/proyectos/las_golondrinas/lasgolondrinas1.png" alt="" width="100%" class="img-responsive"></div>
                    <div class="item mov"><img src="view/componentes/img/proyectos/las_golondrinas/lasgolondrinas2.png" alt="" width="100%" class="img-responsive"></div>
                    <div class="item mov"><img src="view/componentes/img/proyectos/las_golondrinas/lasgolondrinas3.png" alt="" width="100%" class="img-responsive"></div>
                    <div class="item"><img src="view/componentes/img/proyectos/las_golondrinas/lasgolondrinas4.png" alt="" width="100%" class="img-responsive"></div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-12 context-light ">
                           <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1643.7906257362645!2d-71.63694274175833!3d-34.5134988951208!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x96640a0e0f187f13%3A0x62cfa2a87291dea!2sReto%2C%20Peralillo%2C%20O&#39;Higgins!5e0!3m2!1ses-419!2scl!4v1617738130586!5m2!1ses-419!2scl" width="100%" height="630" frameborder="0" style="border:0;" allowfullscreen></iframe>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-12" style="width:100%;height:600px;">
                                <br>
                                <div id="fliplasgolondrinas" style="width:100%;height:100%;">
                                </div>
                            </div>
