...
<div class="page text-center">
            ...
            <nav data-layout="rd-navbar-fixed" data-sm-layout="rd-navbar-fixed" data-md-device-layout="rd-navbar-fixed" data-lg-layout="rd-navbar-static" data-lg-device-layout="rd-navbar-static" data-sm-stick-up-offset="150px" data-md-stick-up-offset="1px" data-lg-stick-up-offset="150px" class="rd-navbar">
                ...
                <div class="rd-navbar-panel">
                    ...
                    <div class="rd-navbar-inner">
                        ...
                        <!-- LOGO-->
                        <div class="rd-navbar-brand"><a href="inicio" class="brand-name"><img src="view/componentes/img/logo/logon.png" width="228" height="83" alt="Parcelas de chile"></a>
                        </div>
    ...
    <main class="page-content">
        ...
        <section class="section-top-70 section-bottom-80">
            <div class="shell">
                <h1>Error 404</h1>
                <h3 class="offset-top-20">Página no encontrada.
                </h3><a href="./" class="offset-top-36 btn btn-base">VISITA EL HOME
                    PAGE</a>
                <p class="offset-top-50 offset-lg-top-70">
                    Desafortunadamente no se pudo encontrar la página que buscabas.</p>
            </div>
        </section>
    </main>
    <!-- FOOTER-->
