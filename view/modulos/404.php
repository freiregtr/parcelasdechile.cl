  ...
  <div class="page text-center">
        ...
        <nav data-layout="rd-navbar-fixed" data-sm-layout="rd-navbar-fixed" data-md-device-layout="rd-navbar-fixed"
          ...
          <div class="rd-navbar-top-panel rd-navbar-collapse">
            <div class="rd-navbar-inner">
              <div class="small">Please <a href="#" data-toggle="modal" data-target="#loginModal">login</a> or <a
                  href="#" data-toggle="modal" data-target="#registerModal">register</a> to create a new listing</div>
          ...
          <div class="rd-navbar-panel">
            ...
            <div class="rd-navbar-inner">
              ...
              <!-- RD Navbar Brand-->
              <div class="rd-navbar-brand"><a href="inicio" class="brand-name"><img src="view/componentes/images/logo.png"
                    width="205" height="27" alt=""></a></div>
              <div class="rd-navbar-contacts rd-navbar-collapse rd-navbar-collapse-2"><span class="semi-small">Get in
                  touch with us</span>
            ...
            <div class="rd-navbar-inner">
              ...
              <ul class="rd-navbar-nav">
                  ...
                  <ul class="rd-navbar-dropdown">
                    <li><a href="#">Header Settings</a>
                      ...
                      <ul class="rd-navbar-dropdown">
                        ...
                        <li><a href="header-centered.html">Centered</a></li>
                      </ul>
                    </li>
                    <li><a href="#">Footer Settings</a>
                      <!-- RD Navbar Dropdown-->
                      <ul class="rd-navbar-dropdown">
                        <li><a href="footer-default.html">Default</a></li>
                        <li><a href="footer-minimal.html">Minimal</a></li>
                        <li><a href="footer-centered.html">Centered</a></li>
                      </ul>
                    </li>
                  </ul>
                </li>
                <li><a href="#">Idx</a>
                  <!-- RD Navbar Dropdown-->
                  <ul class="rd-navbar-dropdown">
                    <li><a href="idx-1.html">Listings Shortcode</a></li>
                    <li><a href="idx-2.html">Single Shortcode</a></li>
                  </ul>
                </li>
                ...
                <li><a href="blog.html">Blog</a>
                  ...
                  <ul class="rd-navbar-dropdown">
                    <li><a href="#">Post Formats</a>
                      <!-- RD Navbar Dropdown-->
                      <ul class="rd-navbar-dropdown">
                        <li><a href="blog-single-post.html">Image</a></li>
                        <li><a href="blog-gallery.html">Gallery</a></li>
                        <li><a href="blog-video.html">Video</a></li>
                        <li><a href="blog-audio.html">Audio</a></li>
                        <li><a href="blog-quote.html">Quote</a></li>
                    ...
                    <li><a href="#">Blog Layout</a>
                      <!-- RD Navbar Dropdown-->
                      <ul class="rd-navbar-dropdown">
                        <li><a href="blog.html">Listing Layout</a></li>
                        <li><a href="blog-list.html">Listing Layout 2</a></li>
                        <li><a href="blog-masonry.html">Masonry Layout</a></li>
                        <li><a href="blog-masonry-3.html">Masonry Layout 3 Cols</a></li>
                        <li><a href="blog-grid.html">Grid Layout</a></li>
                        <li><a href="blog-grid-3.html">Grid Layout 3 Cols</a></li>
                      </ul>
                    </li>
                ...
                <li><a href="#">PROPERTIES</a>
                  <!-- RD Navbar Dropdown-->
                  <ul class="rd-navbar-dropdown">
                    <li><a href="property.html">Property page</a></li>
                    <li><a href="property-add.html">Add Property</a></li>
                    <li><a href="agents.html">Agents</a></li>
                    <li><a href="author.html">Agent page</a></li>
    ...
    <main class="page-content">
      ...
      <section class="section-top-70 section-bottom-80">
        <div class="shell">
          <h1>Error 404</h1>
          <h3 class="offset-top-20">Page not found.</h3><a href="./" class="offset-top-36 btn btn-base">VISIT HOME
            PAGE</a>
          <p class="offset-top-50 offset-lg-top-70">Unfortunately the page you were looking for could not be found.
            Maybe search can help.</p>
          <div class="range range-xs-center offset-top-20">
            <div class="cell-md-6 cell-lg-4">
              <!-- RD Search-->
              <form action="search-results.html" method="GET" class="form-inline-custom rd-search">
                <div class="form-group form-group-sm">
                  <label for="rd-search-form-input" class="form-label">Enter a keyword</label>
    ...
    <footer class="page-footer">
      <div class="shell section-70 section-lg-120">
        <div class="range text-md-left">
          <div class="cell-md-4">
            <h5>About</h5>
            <p class="offset-top-20 offset-md-top-36">We’re hunting for the best gems on the American real estate
              market. With our help you’ll find any house that you want to, be it a humble winter cottage in the state
              of Maine, a median summer apartment in Austin, TX or a huge residential building along Santa Monica
              beaches in California...</p>
          </div>
          <div class="cell-md-4">
            <h5>Recent posts</h5>
            <div class="post-blog-sm offset-top-20 offset-md-top-36"><a href="blog-single-post.html" class="text-bold">A
                beach house at Baja California peninsula</a>
              <p class="small offset-top-7">July 7, 2016</p>
            </div>
            <div class="post-blog-sm offset-top-16"><a href="blog-single-post.html" class="text-bold">Cottage with a big
                pool in Phoenix suburbs, AZ</a>
              <p class="small offset-top-7">July 7, 2016</p>
            </div>
          </div>
          <div class="cell-md-4">
      ...
      <div class="shell section-30">
        <div class="range range-xs-middle">
          ...
          <div class="cell-sm-6 text-sm-left offset-top-20 offset-sm-top-0">
            <p class="small">HomePRO &#169;<span id="copyright-year"></span>. <a href="privacy.html"
              ...
              <div id="login" role="tabpanel" class="fade in tab-pane active">
                <form method="post" class="offset-top-40 rd-mailform text-left">
                  ...
                  <div class="form-group offset-top-7">
                    ...
                    <input id="login-password" type="password" name="password" data-constraints="@Required"
                      class="form-control">
                  </div>
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          <div class="modal-body">
            ...
            <!-- Nav tabs-->
            <ul role="tablist" class="nav nav-tabs nav-tabs-custom">
              <li role="presentation"><a href="#login-2" aria-controls="login" role="tab" data-toggle="tab">Login</a>
              </li>
              <li role="presentation" class="active"><a href="#register-2" aria-controls="register" role="tab"
                  data-toggle="tab">Register</a></li>
            </ul>
            <!-- Tab panes-->
            <div class="tab-content offset-top-20">
              <div id="login-2" role="tabpanel" class="fade in tab-pane">
                <form method="post" class="offset-top-40 rd-mailform text-left">
                  ...
                  <div class="form-group offset-top-7">
                    ...
                    <input id="login-password-2" type="password" name="password" data-constraints="@Required"
                      class="form-control">
                  </div>
                  <div class="offset-top-20 text-center text-sm-left">
                    <button type="submit" class="btn btn-block btn-primary">login</button>
              ...
              <div id="register-2" role="tabpanel" class="fade in tab-pane active">
                <form method="post" class="offset-top-40 rd-mailform text-left">
                  <div class="form-group">
                    ...
                    <input id="register-name-2" type="text" name="name" data-constraints="@Required"
                      class="form-control">
                  </div>
                  <div class="form-group offset-top-7">
                    <label for="register-email-2" class="form-label">Email</label>
                    <input id="register-email-2" type="email" name="email" data-constraints="@Email @Required"
                      class="form-control">
                  </div>
                  <div class="offset-top-20 text-center text-sm-left">
                    <button type="submit" class="btn btn-block btn-primary">register</button>
