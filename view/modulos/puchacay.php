...
<div class="page text-center">
    ...
    <main class="page-content">
        <section class="bg-gray-lighter">
            <div class="shell text-left">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Parcelación "Puchacay"</li>
                </ol>
            </div>
        </section>
        ...
        <!-- PROYECTO LA ROSA CON EL CLAVEL-->
        <section class=" text-center section-bottom-70 page-header bg-image-puchacay">
            <div class="shell section-100 section-lg-top-220 section-lg-bottom-205 context-dark">
                <div><a href="lasgolondrinas" class="label label-primary shadow2">VI región</a></div>
                <br>
                <h1 class="shadow1">Parcelación<br><span class="text-sbold">"Puchacay"</span></h1>
                <div class="range offset-top-30 text-center">
                    <div class="cell-sm-4">
                        <!-- CountTo-->
                        <div data-from="0" data-to="103" class="counter shadow1 text-medium"></div>
                        <h3 class="text-sbold text-base shadow1 text-white">Parcelas</h3>
                    </div>
                    <div class="cell-sm-4">
                        <!-- CountTo-->
                        <div data-from="0" data-to="220" class="counter shadow1 text-medium"></div>
        ...
        <section class="section-top-45 section-bottom-80">
            <div class="shell text-md-left product">
                                    ...
                                    <div class="col-md-6">
                                        <div>
                                            <div class="context-light">
                                                <h2 class="offset-top-50 section-bottom-30">Parcelación <br> <span class="text-sbold"> "Puchacay"</span></h2>
                                            </div>
                                            <p class="section-bottom-30">Región de O'higgins, Rincón del Sauce </p>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="col-md-6">
                                        
                                        <p class="offset-top-20">Nombre de nuestro proyecto Puchacay proviene de Mapudungun y significa: Lugar entre arbustos. La mayoría de las parcelas en este proyecto son 100% planas y las parcelas que se encuentran en altura tienen una vista imperdible.</p>
                                    </div>
                                </div>
                            </div>
                        </section>
                ...
                <div class="container">
                    ...
                    <h2 class="offset-top-50 section-bottom-30 text-center">Venta En Blanco</h2>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                            <img src="view/componentes/img/proyectos/puchacay/plano-puchacay.png" width="100%" frameborder="0" style="border:0" allowfullscreen></img>
                        </div>
                    </div>
                </div>
            ...
            <section class="section-top-70  section-bottom-70">
                    <div class="container-fluid">
                        <div class="card text-center">
                            <div class="card-body ">
                                <a href="https://drive.google.com/file/d/1eoqtO-aR899HjVdvvDmBLrf0n1IglfKE/view?usp=sharing" target="_blank" download="PreciosPuchacay" class="btn btn-primary shadow2">DESCARGAR PLANO</a>
                            </div>
                        </div>
                        <hr>
                    </div>
...
<div class="container">
            ...
            <section id="sliderproyectos ">
                ...
                <div id="child-carousel" data-arrows="true" data-loop="true" data-dots="true" data-swipe="true" data-items="1" data-xs-items="1" data-sm-items="1" data-md-items="3" data-lg-items="3" data-slide-to-scroll="1" class="slick-slider slick-child ">
                    <!-- GALERIA DE IMAGENES-->
                    <div class="item mov"><img src="view/componentes/img/proyectos/puchacay/foto1.jpg" alt="" width="100%" class="img-responsive"></div>
                    <div class="item mov"><img src="view/componentes/img/proyectos/puchacay/foto2.jpg" alt="" width="100%" class="img-responsive"></div>
                    <div class="item mov"><img src="view/componentes/img/proyectos/puchacay/foto3.jpg" alt="" width="100%" class="img-responsive"></div>
                    <div class="item"><img src="view/componentes/img/proyectos/puchacay/foto4.jpg" alt="" width="100%" class="img-responsive"></div>
                    <div class="item"><img src="view/componentes/img/proyectos/puchacay/foto5.jpg" alt="" width="100%" class="img-responsive"></div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-12 context-light ">
                           <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6566.512434311304!2d-71.58590342396704!3d-34.62296497181791!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x96640cd06258b0df%3A0x9c14aba0979f3ba8!2sRinc%C3%B3n%20del%20Sauce%2C%20Pumanque%2C%20O&#39;Higgins!5e0!3m2!1ses-419!2scl!4v1622752839993!5m2!1ses-419!2scl" width="100%" height="630" frameborder="0" style="border:0;" allowfullscreen></iframe>
