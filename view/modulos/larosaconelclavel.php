...
<div class="page text-center">
    ...
    <main class="page-content">
        <section class="bg-gray-lighter">
            <div class="shell text-left">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Parcelación "La Rosa con El Clavel"</li>
                </ol>
            </div>
        </section>
        ...
        <section class=" text-center section-bottom-70 page-header bg-image-larosa">
            <div class="shell section-100 section-lg-top-220 section-lg-bottom-205 context-dark">
                <div><a href="larosaconelclavel" class="label label-primary shadow2">VI región</a></div>
                <br>
                <h1 class="shadow1">Parcelación<br><span class="text-sbold">"La Rosa con El Clavel"</span></h1>
                <div class="range offset-top-30 text-center">
                    <div class="cell-sm-4">
                        <!-- CountTo-->
                        <div data-from="0" data-to="228" class="counter shadow1 text-medium"></div>
                    ...
                    <div class="cell-sm-4">
                        <!-- CountTo-->
                        <div data-from="0" data-to="50" class="counter shadow1 text-medium"></div>
                        <h3 class="text-sbold text-base shadow1 text-white"> KM de Bucalemu</h3>
                    </div>
                </div>
                <br>
                <br>
        ...
        <section class="section-top-45 section-bottom-80">
                                    ...
                                    <div class="col-md-6">
                                        <div>
                                            <div class="context-light">
                                                <h2 class="offset-top-50 section-bottom-30">Parcelación <br> <span class="text-sbold"> "La Rosa con El Clavel"</span></h2>
                                            </div>
            ...
            <section id="sliderproyectos ">
                ...
                <div id="child-carousel" data-arrows="true" data-loop="true" data-dots="true" data-swipe="true" data-items="1" data-xs-items="1" data-sm-items="1" data-md-items="3" data-lg-items="3" data-slide-to-scroll="1" class="slick-slider slick-child ">
                    <!-- GALERIA DE IMAGENES-->
                    <div class="item mov"><img src="view/componentes/img/proyectos/larosaconelclavel/Pum1.jpg" alt="" width="100%" class="img-responsive"></div>
                    <div class="item mov"><img src="view/componentes/img/proyectos/larosaconelclavel/Pum2.jpg" alt="" width="100%" class="img-responsive"></div>
                    <div class="item mov"><img src="view/componentes/img/proyectos/larosaconelclavel/Pum3.jpg" alt="" width="100%" class="img-responsive"></div>
                    <div class="item"><img src="view/componentes/img/proyectos/larosaconelclavel/Pum4.jpg" alt="" width="100%" class="img-responsive"></div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-12 context-light ">
                           <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6568.337518203311!2d-71.65767382275772!3d-34.59989389052004!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x96640c01f9f3c38f%3A0xa8407d2880ee29db!2sPumanque%2C%20O&#39;Higgins!5e0!3m2!1ses-419!2scl!4v1600117851252!5m2!1ses-419!2scl" width="100%" height="630" frameborder="0" style="border:0;" allowfullscreen></iframe>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12" style="width:100%;height:600px;">
                            <br>
                            <div id="fliplarosa" style="width:100%;height:100%;">
                            </div>
                        </div>
