...
<div class="page text-center">
    ...
    <main class="page-content">
        <section class="bg-gray-lighter">
            <div class="shell text-left">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Fundo "La Refalosa"</li>
                </ol>
            </div>
        </section>
        ...
        <section class=" text-center section-bottom-70 page-header bg-image-larefalosa">
            <div class="shell section-100 section-lg-top-220 section-lg-bottom-205 context-dark">
                ...
                <br>
                <h1 class="shadow1">Parcelación<br><span class="text-sbold">"La Refalosa"</span></h1>
                <div class="range offset-top-30 text-center">
                    <div class="cell-sm-4">
                        <!-- CountTo-->
                        <div data-from="0" data-to="36" class="counter shadow1 text-medium"></div>
        ...
        <section class="section-top-45 section-bottom-80">
            <div class="shell text-md-left product">
                                    ...
                                    <div class="col-md-6">
                                        <div>
                                            <div class="context-light">
                                                <h2 class="offset-top-50 section-bottom-30">Parcelación <br> <span class="text-sbold"> "La Refalosa"</span></h2>
                                            </div>
                ...
                <div class="container">
                    <div class="context-light">
                    <h2 class="offset-top-50 section-bottom-30 text-center">Precios</h2>
                </div>
                                    <div class="row">
                                        <div class="col-md-12">
                            <img src="view/componentes/img/proyectos/la_refalosa/plano-larefalosa-05.png" width="100%" frameborder="0" style="border:0" allowfullscreen></img>
                        </div>
                    </div>
                </div>
            ...
            <section id="sliderproyectos ">
                ...
                <div id="child-carousel" data-arrows="true" data-loop="true" data-dots="true" data-swipe="true" data-items="1" data-xs-items="1" data-sm-items="1" data-md-items="3" data-lg-items="3" data-slide-to-scroll="1" class="slick-slider slick-child ">
                    <!-- GALERIA DE IMAGENES-->
                    <div class="item mov"><img src="view/componentes/img/proyectos/la_refalosa/larefalosa2.jpg" alt="" width="100%" class="img-responsive"></div>
                    <div class="item mov"><img src="view/componentes/img/proyectos/la_refalosa/larefalosa3.jpg" alt="" width="100%" class="img-responsive"></div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12" style="width:100%;height:600px;">
                            <br>
                            <div id="fliplarefalosa" style="width:100%;height:100%;">
                            </div>
                        </div>
